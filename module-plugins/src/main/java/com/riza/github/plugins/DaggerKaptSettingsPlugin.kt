package com.riza.github.plugins

import org.gradle.api.Plugin
import org.gradle.api.Project
import org.jetbrains.kotlin.gradle.plugin.KaptExtension

class DaggerKaptSettingsPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        kaptPlugin.javacOptions {
            option("-Adagger.validateTransitiveComponentDependencies=DISABLED")
            //option("-Adagger.strictSuperficialValidation=DISABLED")
        }
    }
}
